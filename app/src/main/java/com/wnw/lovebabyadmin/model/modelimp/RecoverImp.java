...
public class RecoverImp implements IRecover {
    private Context context;
    private RecoverListener recoverListener;
    private boolean isSuccess;

    @Override
    public void recover(Context context, RecoverListener recoverListener) {
    ...
    private void sendRequestWithVolley(){
        String url = NetConfig.SERVICE + NetConfig.RECOVER;
        Log.d("url",url );
    ...
    private void retData(){
        if(recoverListener != null){
            recoverListener.complete(isSuccess);
        }
    }
}
