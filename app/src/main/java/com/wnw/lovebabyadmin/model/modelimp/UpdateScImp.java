...
public class UpdateScImp implements IUpdateSc{
    private Context context;
    private ScUpdateListener updateListener;
    private boolean isSuccess;


    @Override
    public void updateSc(Context context, Sc sc, ScUpdateListener updateListener) {
    ...
    private void parseNetUserWithJSON(String response){
        try{
            ...
            isSuccess = jsonObject.getBoolean("updateSc");
